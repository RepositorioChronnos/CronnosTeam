...
ADDON=xbmcaddon.Addon(id='plugin.video.chronos')
INTRO = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.chronos/intro.mp4'))
...
def futures():
    print "futures"
    url = "http://proyectoluzdigital.info/download/script.module.futures.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'pld5.zip')
...
def request():
    print "request"
    url = "http://proyectoluzdigital.info/download/script.module.requests.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'pld5.zip')
...
def singledispatch():
    ...
    url = "http://proyectoluzdigital.info/download/script.module.singledispatch.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'pld5.zip')
...
def livestreamer():
    print "livestreamer"
    url = "http://proyectoluzdigital.info/download/script.module.livestreamer.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'pld6.zip')
